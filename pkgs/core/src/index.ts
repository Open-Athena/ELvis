...
export { computeSortedSamples, densityAtQuantile } from './utils/density-quantile.ts'
...
export { HeatmapHistogram } from './components/HeatmapHistogram.tsx'
export { DiffSources } from './components/DiffSources.tsx'
export { DrawerSection, DRAWER_EVT, getLastTouchedSection } from './components/DrawerSection.tsx'
